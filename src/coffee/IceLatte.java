...
public class IceLatte extends JFrame implements ActionListener ,MouseListener{
	JTextField mony,Qty;
        JLabel LatteText;
    ...
    public IceLatte(){
		...
		panel.add(Picture);
		ImageIcon image=new ImageIcon("latte.png");
		Picture.setIcon(image);
		
		LatteText=new JLabel("Ice Latte");
		LatteText.setBounds(100, 290, 200, 50);
		LatteText.setFont(new Font("Ebrima",Font.BOLD,40));
		add(LatteText);
