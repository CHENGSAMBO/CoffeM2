...
public class Americano extends JFrame implements ActionListener{
	JTextField mony,Qty;
        JLabel AmericanoText;
	...
	Americano(){
		...
		panel.add(Picture);
		ImageIcon image=new ImageIcon("Americano1 .png");
		Picture.setIcon(image);
		
		AmericanoText=new JLabel("Americano");
		AmericanoText.setBounds(100, 290, 200, 50);
		AmericanoText.setFont(new Font("Ebrima",Font.BOLD,40));
		add(AmericanoText);
