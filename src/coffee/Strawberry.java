...
public class Strawberry extends JFrame implements ActionListener{
	JTextField mony,Qty;
        JLabel StrawberryText;
	...
	Strawberry(){
		...
		panel.add(Picture);
		ImageIcon image=new ImageIcon("Strawbery1.png");
		Picture.setIcon(image);
		
		StrawberryText=new JLabel("Strawberry");
		StrawberryText.setBounds(100, 290, 200, 50);
		StrawberryText.setFont(new Font("Ebrima",Font.BOLD,40));
		add(StrawberryText);
			...
			TextIce=little.getText();
                 ...
                 if(e.getSource()==Order){
                    ...
                    try (BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\netbean\\Coffee\\src\\coffee\\order.txt", true))) {
                        ...
                        writer.write("Drink: " + StrawberryText.getText() + "\t");
                   ...
                   new ABA(mony.getText(),TextSize,Textsuger,TextIce,StrawberryText.getText(),String.valueOf(size),Qty.getText());
                   dispose();
                 }
	}
}
